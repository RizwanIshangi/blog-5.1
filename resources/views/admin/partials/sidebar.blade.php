<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                 <li><a href="{{url('admin/users/add')}}"><i class="fa fa-angle-double-right"></i>Add User</a></li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a href="{{url('/admin/inbox')}}"><i class="fa fa-angle-double-right"></i>Contact Info</a></li>
