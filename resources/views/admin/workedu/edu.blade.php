            ...
            <div class="box">
                ...
                <div class="box-footer clearfix">
                  <ul class="pagination pagination-sm no-margin pull-right">
                      @if($data['edu']->previousPageUrl())

                        <li><a class="next page-numbers" href="{{$data['edu']->previousPageUrl()}}"><< Previous</a></li>

                      @endif

                      @if($data['edu']->hasMorePages())

                        <li><a class="next page-numbers" href="{{$data['edu']->nextPageUrl()}}">Next >></a></li>
