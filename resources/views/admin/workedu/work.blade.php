            ...
            <div class="box">
                ...
                <div class="box-footer clearfix">
                  <ul class="pagination pagination-sm no-margin pull-right">
                      @if($data['work']->previousPageUrl())

                        <li><a class="next page-numbers" href="{{$data['work']->previousPageUrl()}}"><< Previous</a></li>

                      @endif

                      @if($data['work']->hasMorePages())

                        <li><a class="next page-numbers" href="{{$data['work']->nextPageUrl()}}">Next >></a></li>
