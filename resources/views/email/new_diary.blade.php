...
@section('contents')
	...
	A new diary was published in <a href="{{url('/')}}">rizwan.co</a>. Published by <a href="{{url('/user/'.$author['id'])}}">{{$author['name']}}</a> You can checkout this diary by clicking the link bellow.<br/>
