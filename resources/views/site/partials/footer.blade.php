        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-lg-3">
                <a href="#" class="hover-animate">
                    <span class="ukie-icons hover-animate"><i class="fa fa-phone"></i></span> +92 346 799 1895
                </a>
            </div>
            <!-- end phone number -->
            <!-- start email -->
            <div class="col-xs-12 col-sm-6 col-lg-3">
                <a href="#" class="hover-animate">
                    <span class="ukie-icons hover-animate"><i class="fa fa-paper-plane"></i></span> rizwan.ishangi@gmail.com
                </a>
            </div>
            <!-- end email -->
            <!-- start address -->
            <div class="col-xs-12 col-sm-6 col-lg-3">
                <a href="#" class="hover-animate">
                    <span class="ukie-icons hover-animate"><i class="fa fa-map-marker"></i></span> Isalmabad capital territory
                </a>
            </div>
            <!-- end address -->
            ...
            <div class="col-xs-12 col-sm-6 col-lg-3 text-right">
                <span class="copyright">{{date('Y')}} &copy; R!ZWAN</span>
            </div>
            <!-- end Copyright -->
        </div>
        <!-- end row -->
 ...
 <script type="text/javascript" src="//maps.google.com/maps/api/js?sensor=true"></script>
    ...
    $(document).ready(function(){
      ...
      map.addMarker({
        lat: 23.803947,
        lng: 90.352951,
        title: 'Rizwan Ishangi',
        infoWindow: {
          content: '<div  align="center"><img src="{{asset("assets/img/nahid_avatar.jpg")}}" class="img-circle" width="70px" /><h2>Rizwan Ishangi</h2>  <p><strong>codesum</strong>, i-8 markaz islamabad</p></div>'
        }
      });
    });
  </script>
