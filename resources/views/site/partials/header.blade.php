...
<head>
    <meta charset="utf-8" />
    <title>{{$pageInfo['siteTitle']}} :: R!zwan</title>
    <meta name="author" content="Rizwan Ishangi" />
    <meta name="keywords" content="Rizwan, Ishangi, html5, php, laravel, laravel 5, blog, bangla blog, diary, angular js, web artisan, js, javascript, bangladesh, dhaka, barisal, bubt, bubt student" />
    <meta name="description" content="Hi, This is Rizwan from Pakistan. I know, you are looking for an excellent & professional web developer. That's why I'm here for you right now! I've been working on PHP, jQuery, jQuery UI, Twitter Bootstrap and Laravel 4 for a long time. It's not me alone, I have a great team named CODESUM. If you have a job to be done, hand it over & RELAX forever... :)" />

    <meta property="og:title" content="{{$pageInfo['siteTitle']}} :: RIZWAN" />
    <meta property="og:site_name" content="RIZWAN | The Alien" />
    <meta property="og:description"  content="{{isset($pageInfo['siteContents'])?$pageInfo['siteContents'] : 'Hi, This is RIZWAN from Southern Asia. I know, you are looking for an excellent & professional web developer. Thats why I am here for you right now! I have been working on PHP, jQuery, jQuery UI, Twitter Bootstrap and Laravel 4 for a long time. Its not me alone, I have a great team named CODESUM. If you have a job to be done, hand it over & RELAX forever... :)'}}" />

    <meta  property="og:type" content="article" />
    <meta  property="og:url" content="{{Request::url()}}" />
    <meta  property="og:image" content="{{ isset($pageInfo['siteImage'])?asset('media/diary/'.$pageInfo['siteImage']) : asset('assets/img/rizwan_avatar.jpg')}}" />

    <meta name="google-site-verification" content="1_Y-hxUZol_K73c_qTrkVJbuWp9_YJYEIuwWL73edzc" />
    <link href="https://plus.google.com/u/0/+RizwanIshangi" rel="publisher">
  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('/')}}">R!ZWAN | Quick Prgorammer</a>
          </div>
          <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
              ...
              @if(Auth::check())
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="{{url(Auth::user()->image)}}" style="width:19px; height:19px; border-radius:50%" /> <span class="caret"></span></a>
